...
import com.example.tyl5.bean.UserInfo;
import com.example.tyl5.database.UserDBHelper;
import com.example.tyl5.util.DateUtil;
import com.example.tyl5.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "公司用户","唐应林-18990170"};
